...
from KerbalStuff.objects import User, Mod, ModVersion, DownloadEvent, FollowEvent, ReferralEvent, Featured, Media, GameVersion, Category
...
def edit_mod(id, mod_name):
    ...
    if request.method == 'GET':
        ...
        tags = request.form.get('other-authors')
...
@with_session
def create_mod():
    return render_template("create.html", game_versions=GameVersion.query.order_by(desc(GameVersion.id)).all(), category="asd")
