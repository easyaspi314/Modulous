...
document.getElementById('add-shared-author').addEventListener('click', (e) ->
    ...
    xhr.send(data)
, false)
document.getElementById('add-other-author').addEventListener('click', (e) ->
    e.preventDefault()
...
, false)
document.getElementById('new-other-author').addEventListener('keypress', (e) ->
    if e.keyCode == 13
        e.preventDefault()
        document.getElementById('add-other-author').click()
, false)
